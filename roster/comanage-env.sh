...
export APACHE_SHIBD_DIR=/root/np3m-roster/apache-shibd
...
export COMANAGE_REGISTRY_VIRTUAL_HOST_FQDN=roster.np3m.org
export COMANAGE_REGISTRY_SLAPD_BASE_IMAGE_VERSION=1
export COMANAGE_REGISTRY_SLAPD_IMAGE_VERSION=1
export OLC_SUFFIX=dc=np3m,dc=org
export OLC_ROOT_DN=cn=admin,dc=np3m,dc=org
