...
//    MatchStrategyEnum::External   => 'External',
  ...
  'er.auth.roles' =>  'You are not yet registered as an NP3M member. If you have already requested enrollment, your application is still being processed. You wll be able to login once your application is approved.',
  ...
  'rs.pt.create.self' => 'Application to join NP3M created. Please look for an email from comanage-do-not-reply@np3m.org and follow the instructions to complete sign up.', 
